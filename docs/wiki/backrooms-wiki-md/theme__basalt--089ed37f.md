---
title: "BASALT Theme"
source: "https://backrooms-wiki.wikidot.com/theme:basalt"
retrieved_at: "2026-08-23T23:41:11+00:00"
...
:root {
    ...
    --logo: url(http://scutoidbox.wikidot.com/local--files/component:parallax-engine/basalt-logo.svg);
    ...
    --title-border-colorBasalt: var(--basalt-overtone);
...
#page-content {
    font-size: calc(var(--true-font-size) * 1.13);
}
...
div.creditButtonStandalone>p> a::after {
    background-color: rgb(var(--rate-module-text-color));
}
...
:root {
    ...
    --logo: url(http://backrooms-wiki.wikidot.com/local--files/component:theme/logo.svg);
...
![basalt-theme-logo.svg](https://scp-wiki.wikidot.com/local--files/theme:basalt/basalt-theme-logo.svg)

**On any page:**  
**[[include :backrooms-wiki:theme:basalt]]**

> Mostly unedited from its original form on the SCP Wiki, this has been ported to the Backrooms Wiki for use in articles here and as a base for new themes that do not want to use Black Highlighter for their design. The logo image used is taken from the BASALT page on the [Chinese Backrooms Wiki](theme__basalt--089ed37f.md).
...
- **acs-itemnum=a**   Restores [ACS](https://scp-wiki.wikidot.com/anomaly-classification-system-guide) "ITEM#:" text
- **disable-acs-anim=a**   Disables [ACS Animation](https://scp-wiki.wikidot.com/component:acs-animation) component
...
**[[div class="raisa\_memo"]]**

[+ More memos](javascript:;)

[- Hide](javascript:;)

With icons by ([see here](https://scp-wiki.wikidot.com/desk-of-junior-designer-s-yvonne))

**[[div class="classification\_memo"]]**

**[[div class="ettra\_memo"]]**

**[[div class="ethics\_memo"]]**

**[[div class="temporal\_memo"]]**

**[[div class="overwatch\_memo"]]**

**[[div class="miscomm\_memo"]]**

![basalt_scp_logo-for_lightmode.svg](https://scp-wiki.wikidot.com/local--files/theme:basalt/basalt_scp_logo-for_lightmode.svg)

Image block.

A horizontal rule can be created with 6 hyphens "------"[1](javascript:;) and extends across the whole page if it's not placed inside anything (eg a blockquote).
...
This system is designed to connect with the [Anomaly Classification System](https://scp-wiki.wikidot.com/anomaly-classification-system-guide); each color signifies a different security clearance level.
...
![basaltlogo.svg](https://cdn.scpwiki.com/theme/en/basalt/basaltlogo.svg)
...
Source: [https://backrooms-wiki.wikidot.com/theme:basalt](https://backrooms-wiki.wikidot.com/theme:basalt)
