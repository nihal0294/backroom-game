---
title: "Desolation Canon Hub"
source: "https://backrooms-wiki.wikidot.com/desolation-canon-hub"
retrieved_at: "2026-08-23T23:36:06+00:00"
...
[(link)](desolation-backrooms-guide.md)
...
*For an in-universe introduction to Desolation Canon, see the [Desolation Backrooms Guide](desolation-backrooms-guide.md).*

*Created by*

**Desolation Canon** focuses on a version of the Backrooms which has few levels and entities, and which turns things within it into parts of itself via a process called **desolation**.
...
- [*Entities*](javascript:;)
- [*Objects*](javascript:;)
- [*Other Locations*](javascript:;)

These are the Backrooms' 11 levels, and the sub-levels that lie within them:

- [Level 0 - "Yellow Halls"](https://backrooms-wiki.wikidot.com/desolation-level-0)
- [Level 1 - "Concrete Lots"](https://backrooms-wiki.wikidot.com/desolation-level-1)
- [Level 2 - "Pipe-lined Halls"](https://backrooms-wiki.wikidot.com/desolation-level-2)
- [Level 3 - "Electricals"](https://backrooms-wiki.wikidot.com/desolation-level-3)
- [Level 4 - "Blue Office"](desolation-level-4.md)
  - [Sub-Level - "The Hospital"](https://backrooms-wiki.wikidot.com/desolation-the-hospital)
- [Level 5 - "The Hotel"](desolation-level-5.md)
- [Level 6 - "Darkness"](https://backrooms-wiki.wikidot.com/desolation-level-6)
- [Level 7 - "The Ocean"](https://backrooms-wiki.wikidot.com/desolation-level-7)
- [Level 8 - "Caves"](https://backrooms-wiki.wikidot.com/desolation-level-8)
- [Level 9 - "Dark Suburbs"](desolation-level-9.md)
- [Level 10 - "The Fields"](desolation-level-10.md)

These are the few **entities** of the Backrooms — most commonly the desolate remains of organisms who enter it.

- [Facelings](desolation-facelings.md)
- [Hounds](desolation-hounds.md)

These are the **objects** dotted around the Backrooms, and the desolate remains of objects from [Earth](https://backrooms-wiki.wikidot.com/desolation-earth):

- [Recordless Player](object-91.md)

These are the enigmatic and poorly documented **secret levels** of the Backrooms, the enigmatic spaces beyond the main 11:

- None documented yet.

## Tales & Series

- [*Homeward Bound*](javascript:;)
- [*Misc.*](javascript:;)

- [Chapter 1](homewardbound-ch-1.md)
- [Chapter 2](homewardbound-ch-2.md)

- [Desolation Backrooms Guide](desolation-backrooms-guide.md)
- [A Dog's Last Request](a-dogs-last-request.md)

## Contribution

- [*Writing Places*](javascript:;)
- [*Writing Entities*](javascript:;)
- [*Writing Objects*](javascript:;)
- [*Extras*](javascript:;)
- [*Canon Crossing*](javascript:;)

There are only 11 levels to write for this canon, levels 0-11. After that, no more main levels can fit into the canon properly, but don't fret, since that's not the only way to write a place for Desolation Canon!

There are two main ways to do so:

## Sub-Levels

**Sub-levels** in Desolation Canon are infinite spaces, different from normal levels in that they:

- Have only one entrance, localised as one point on a particular parent level
- Are the result of a structure clipping into or being constructed in the Backrooms, which becomes an infinite space via desolation.
- Are usually more dangerous, as they tend to be difficult to escape and lack a consistent source of [Almond Water](https://backrooms-wiki.wikidot.com/desolation-almond-water). That can be deviated from, though.

## Secret Levels

**Secret levels** in Desolation Canon are levels, different from normal levels in that they:

- Are not known widely throughout the Backrooms, including to most members of the M.E.G.
  - Either because they are difficult to enter, or;
  - Because they are impossible or unlikely to escape from.
- Are generally more dangerous than normal levels or sub-levels.
- Are extremely mysterious and have undocumented properties, if they are documented at all.

Examples of main canon pages that would fit here as **secret levels** are are [The End](level-601.md) and [The Hive](level-276.md).

Desolation Canon is meant to focus more on people facing a very lonely and uninhabited Backrooms, without too many common entities. There are a few consistent traits that entities in the canon do **not** have:

- Desolation Canon entities do not have human-level intelligence.
- Desolation Canon entities are not passive.
- Desolation Canon entities do not organise into groups of any kind.

Avoid writing superfluous entities, this canon isn't really about them. That being said, if you want, you can still write entities for the canon!

Objects in desolation are either

- Parts of levels, that fit the level's theme
- The result of desolation on an object from Earth.

You can do as you wish with them, just get the vibe right.

| Wrong | Right |
| --- | --- |
| Proper nouns for Entities, Objects, Levels, Hounds, Facelings, etc. | Regular nouns for entities, objects, levels, hounds, facelings, etc. |
| Calling where we come from 'the Frontrooms' | Calling where we come from 'Earth' or 'Reality' or 'Home', opinions among wanderers will differ but 'Frontrooms' is just plain strange. |
| Humans have developed knowledge of the Backrooms | They don't. They don't even have words for most things. |

As its own universe, Desolation Canon probably won't work for crossing with anything else. You could try to do some sort of a crossover, with someone from the regular Backrooms entering into the Desolation one… I suppose it's accessible through the [Middlesorts](middlesorts.md)…

It would also probably be interesting to see Desolation Canon takes on other canons — you're totally free to do something like that, but it might not be a good candidate for actual inclusion in the other canon since it most likely will conflict with the rest of it quite a lot. Do whatever you like :)
...
> "[Desolation Canon Hub](desolation-canon-hub.md)" by scutoid studios, from the [Backrooms Wiki](index.md). Source: [https://backrooms-wiki.wikidot.com/desolation-canon-hub](desolation-canon-hub.md). Licensed under [CC-BY-SA-3.0](https://creativecommons.org/licenses/by-sa/3.0/).

- - \_

  [+ Embed citation as HTML](javascript:;)[- Embed citation as HTML](javascript:;)

  "<a href="https://backrooms-wiki.wikidot.com/desolation-canon-hub">Desolation Canon Hub</a>" by scutoid studios, from the <a href="http://backrooms-wiki.wikidot.com/">Backrooms Wiki</a>. Source: <a href="https://backrooms-wiki.wikidot.com/desolation-canon-hub">https://backrooms-wiki.wikidot.com/desolation-canon-hub</a>. Licensed under <a href="https://creativecommons.org/licenses/by-sa/3.0/">CC-BY-SA-3.0</a>.
...
Source: [https://backrooms-wiki.wikidot.com/desolation-canon-hub](https://backrooms-wiki.wikidot.com/desolation-canon-hub)
