---
title: "Conductor Os"
source: "https://backrooms-wiki.wikidot.com/fragment:conductor-os"
retrieved_at: "2026-08-23T23:42:17+00:00"
license: CC-BY-SA-3.0
---

# Conductor Os

[![NS_Button.png](https://backrooms-wiki.wdfiles.com/local--files/fragment:conductor-os/NS_Button.png)](http://backrooms-wiki.wikidot.com/the-conductor/offset/1)

![OSCONDUCTORTEXT.gif](https://backrooms-wiki.wdfiles.com/local--files/fragment:conductor-os/OSCONDUCTORTEXT.gif)

![OS_Conductor_Render.png](https://backrooms-wiki.wdfiles.com/local--files/fragment:conductor-os/OS_Conductor_Render.png)
...
![OSQNATEXT.gif](https://backrooms-wiki.wdfiles.com/local--files/fragment:conductor-os/OSQNATEXT.gif)
...
My reason for going by "Conductor" is a bit geeky, but if you insist, that came from when I was calling Neon Shuffle's boards "experiments" in the early concept stages. I figured I'd call myself "The Conductor" because i was **conduct**ing the experiments. It's clever, but a bit of a stretch in hindsight…
...
Eh, let's not spoil the Big Surprise™️ here. Anywayz, **THAT'S ALL 4 NOW!!!!!!!!!** Be sure to stop by [Level 158](level-158.md) if you have the chance, and remember to **STAY WICKED!!!!!!!!!!!!**
...
Conductor renders made by GhostlyGlyphs  
[link to the theme](theme__onslaught--a0b36d87.md)
...
Source: [https://backrooms-wiki.wikidot.com/fragment:conductor-os](https://backrooms-wiki.wikidot.com/fragment:conductor-os)
