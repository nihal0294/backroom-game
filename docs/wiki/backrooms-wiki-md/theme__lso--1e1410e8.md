---
title: "The Liminal Space Organization Theme"
source: "https://backrooms-wiki.wikidot.com/theme:lso"
retrieved_at: "2026-08-23T23:41:26+00:00"
license: CC-BY-SA-3.0
---

# The Liminal Space Organization Theme
...
The theme is intended for the Liminal Space Organization GOI, and the Spacetime Canon, which is currently being written.  
To import this theme into your page, put the following code anywhere inside it:

[[include :backrooms-wiki:theme:lso]]
...
:root{
    --logo-image: url("http://backrooms-wiki.wikidot.com/local--files/theme:lso/Logo");
    --header-title: "Liminal Space Organization";
    --header-subtitle: "Discovering the Liminal Space.";
    ...
    --ctv-background-color: 20, 20, 20;   /*   var(--ctv-background-color);   */
    --ctv-main-color: 68, 42, 83;    /*   var(--ctv-main-color);   */
    --ctv-accent-color: 241, 177, 0;    /*   var(--ctv-accent-color);   */
    --ctv-dark-accent: 117, 84, 0;  /*   var(--ctv-dark-accent);   */
...
/* sidebar bug fix */
  ...
  --sidebar-width-on-mobile: calc(var(--base-font-size) * (280/15));
...
Source: [https://backrooms-wiki.wikidot.com/theme:lso](https://backrooms-wiki.wikidot.com/theme:lso)
