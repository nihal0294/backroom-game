---
title: "Liminal Sigma"
source: "https://backrooms-wiki.wikidot.com/theme:liminal-sigma"
...
This theme was designed by to use for a more minimalistic page design than full nuliminal offers. It's Liminal, but based on SCP Sigma-10. If it were up to me, this would have been the site theme from the start, and people would opt into BHL on their pages (since it loads slowly). Design and colours for Liminal theme was by !! stephlynch moment….

To import it into your pages, use:

> [[include :backrooms-wiki:theme:liminal-sigma]]

BEFORE any other CSS you want to add.

If you want to use this as a base for your theme, you totally can! It has the same colour variables to edit that Liminal does[1](javascript:;).
...
[1](javascript:;). but if you want to make a dark theme, you'll have to do more editing as some native wikidot things don't have the variables assigned to them

---

Source: [https://backrooms-wiki.wikidot.com/theme:liminal-sigma](https://backrooms-wiki.wikidot.com/theme:liminal-sigma)
