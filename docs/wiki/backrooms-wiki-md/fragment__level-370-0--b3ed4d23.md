---
title: "Level 370 0"
source: "https://backrooms-wiki.wikidot.com/fragment:level-370-0"
...
rating: +2[+](javascript:; "I like it")[–](javascript:; "I don't like it")[x](javascript:; "Cancel my vote")
...
![Missing alt text.](https://backrooms-wiki.wdfiles.com/local--files/fragment:level-370-0/307table.jpg)

One of many tables within Level 370, showcasing an abandoned game that was in-play.
...
![Missing alt text.](https://backrooms-wiki.wdfiles.com/local--files/fragment:level-370-0/307game.jpg)

A game being played by one of this level's groups.

Despite coming across as ordinary, each of Level 370's pool tables produce "prizes" upon a game of pool being won. Whilst regular billiard pool[3](javascript:;) is exceptionally easy to cheat, winning in this level has to be done fairly; following all predetermined rules of the table itself. Should one play fairly, the winner shall receive material prizes such as catalogued, anomalous [objects](objects.md), money, perishables, or occasionally even trophy cups which contain unique inscriptions on fake golden plaques.[4](javascript:;)

Whilst losing individuals are not subjugated to any form of punishment for not coming first, an incredibly rich and competitive culture has formed around Level 370, which has shaped its usage and existence from as early as the 2000's. Even when the level was in a more dangerous state, tournaments were held in quinquennial gaps by many former groups such as the [F.T.B](level-230.md), [Hyperia](level-29.md), many towns on [Level 11](level-11.md) prior to that level's unification, [The M.E.G](the-m-e-g.md), [The Border](level-125.md), and even [The Republic of the Valley](level-186.md).

Of course, in more recent years, Level 370 has become less used after the initial amalgamation. The tournaments that would previously bring entire organisations together across The Backrooms have been moved to take place mainly on [Level 11](level-11.md), or [Level 13.1](https://backrooms-wiki.wikidot.com/level-13-1). This shifting has been done to reduce travel times of spectators and players alike, given the increased age of the veteran players, among other factors. In the years following the unofficial departure from the level, maintenance crews have occasionally been sent into Level 370 in order to maintain and upkeep it. This upkeeping is done mainly as a preventative measure in order to ensure that the theory about the level decaying if it is not maintained does not occur, should it be true in the first place.
...
![Missing alt text.](https://backrooms-wiki.wdfiles.com/local--files/fragment:level-370-0/307archival.jpg)
...
![370.jpg](https://backrooms-wiki.wdfiles.com/local--files/fragment:level-370-0/370.jpg)  
...
**Egg1RL**  Today at 13:11  
![307.jpg](https://backrooms-wiki.wdfiles.com/local--files/fragment:level-370-0/307.jpg)  
...
![Missing alt text.](https://backrooms-wiki.wdfiles.com/local--files/fragment:level-370-0/208sign.jpg)

The sign to an entrance to Level 370, found in Level 209.

- Level 370 can be accessed from [Level 11](level-11.md), [Level 153](level-153.md), and [Level 209](level-209.md), by finding a British pub anywhere down the respective level's roads.[5](javascript:;) In a similar vein, Level 370 can be accessed from [Level 82](level-82.md) via going into any stalls based around pub, alcohol, or billiard pool.
- Within [Level 20](trimmed__level-20--5c1a83ba.md), [Level 598](level-598.md), and [level-21](level-21.md), occasional doors constructed out of a dark black wood act as direct access to Level 370, with doors in the latter level usually appearing with pool ball images inscribed onto them.
- [Level 108](trimmed__level-108--cc7a6847.md), [Level 214](level-214.md), and [Level 853](level-853.md) all contain an unknown, yet small number of rarely appearing billiard pool tables. Attempting to play any kind of pool game with these tables will result in all players being transported to Level 370.
- Walking into any door on [Level 196](level-196.md) labelled with a blue sign that is printed with a full set of 15 coloured pool balls will bring you to Level 370.

#### Exits

- Going through glowing doors of gray, black, white, or yellow wood will lead to [Level 11](level-11.md), [Level 64](level-64.md), [Level 218](level-218.md), and [Level 410](level-410.md) respectively.
- Ascending up any flights of stairs leads to [Level 54](level-54.md).
- Exiting to [Level 215](level-215.md) can be done by entering into any closet space which appears eroded and covered in rust.[6](javascript:;) In a similar vein, closet interiors covered in bright neon lights lead to [Level 808](level-808.md).
- A singular wall on one of Level 370's outer walls has been recorded to resemble that of the exterior of a mall store. Going through the door on this wall leads to [Level 224](level-224.md).
- Noclipping through any windows displaying sights of trees usually leads one to [Level 309](level-309.md), and noclipping into windows which display a more suburban aesthetic tends to lead to [Level 995](level-995.md).
- Noclipping into any bookshelves on Level 370 that more greatly resemble store aisle shelves will lead to either [level-423](trimmed__level-423--10459914.md) or [Level 480](level-480.md).
...
![042postcard.png](https://backrooms-wiki.wdfiles.com/local--files/fragment:level-370-0/042postcard.png)
...
Spacebars, man, they're helpful.  
Written by [Boring Talking](greggita-mahayfio.md) .\_.?
...
[read just the level here!](http://backrooms-wiki.wikidot.com/level-370/offset/1)

« [Level 369](level-369.md) | Level 370 | [Level 371](level-371.md) »

Footnotes

[1](javascript:;). These measurements were attained by calculating an average from the rooms from going in the few straight line routes that exist throughout Level 370.

[2](javascript:;). A subject which is tackled further down this article.

[3](javascript:;). As well as most of its variations.

[4](javascript:;). These inscriptions are usually rather broad and bland, such as "You did it!" "Well done!" or occasionally "You're winner!" It is unknown why the spelling mistake occurs.

[5](javascript:;). Or singular road, in the case of Level 153 and Level 209.

[6](javascript:;). This rust is not the same type of anomalous rust found on Level 215 itself, and is instead typical iron rust.

---

Source: [https://backrooms-wiki.wikidot.com/fragment:level-370-0](https://backrooms-wiki.wikidot.com/fragment:level-370-0)
