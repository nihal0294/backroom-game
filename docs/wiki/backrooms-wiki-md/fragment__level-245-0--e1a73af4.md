---
title: "fragment:level-245-0"
source: "https://backrooms-wiki.wikidot.com/fragment:level-245-0"
retrieved_at: "2026-08-23T23:36:33+00:00"
license: CC-BY-SA-3.0
---

# fragment:level-245-0
...
Unable to connect to Leaders servers. This is probably a temporary issue. If this error persists, please contact Leaders tech support.
...
![archway_new.png](https://backrooms-wiki.wdfiles.com/local--files/theme%3Aarchway-os/archway_new.png)

---

Archway OS Version 7.3

Created by The Leaders.

[ArchwayNET](javascript:;)
...
# ArchwayNET is temporarily unavailable.

Unable to connect to Leaders servers. This is probably a temporary issue. If this error persists, please contact Leaders tech support.

[ArchwayFiles](javascript:;)

[+ show block](javascript:;)

[– hide block](javascript:;)

# ArchwayFiles Explorer
...
![ClassC.png](https://backrooms-sandbox-2.wdfiles.com/local--files/halo3rodentsandbox/ClassC.png)

# Layout and Effects

![Two rusty shipwrecks lying close to each other.](https://backrooms-sandbox-2.wdfiles.com/local--files/halo3rodentsandbox/shipwreck2.png)
...
Alongside a handful of other scenes, such as [Scene-03.0](level-0.md), Scene-08.2 is an entrance point to the DevRooms. Wanderers who enter the DevRooms through Scene-08.2 exclusively entered the DevRooms while at sea. Unlike other entrance points, the transition is often barely noticeable.

# Discovery and Initial Exploration

During a routine exploration mission in [Scene-05.4](level-121.md) in April 1975, the crew of the LRV Zheng He sailed into a storm. They found themselves in a new scene after emerging from the storm, which was later given the provisional designation of Scene-08.2[1](javascript:;). The crew of the LRV Zheng He performed a survey of the scene and prepared to leave in order to report their findings. After several days of exploration, they had found no way out of the scene.
...
**UNKNOWN VESSEL:** We were fishing in Aquatic 5. What people insist on calling [Scene-08.8](level-180.md) now. Then a storm came out of nowhere. Never saw one like it before. There were a few moments we thought we were going to sink. Then we found ourselves here. We've been here for a week or two. Rations ran out after a few days. Then all we had to eat were the fish in the sea, and all we had to drink was the rain. Plenty of both, though. Never thought I'd be glad for so much rain. How did you guys end up here?
...
When word of this discovery reached Port Sanctuary, Dr. Arnold Moss[3](javascript:;) and several other researchers urged that the cargo be delivered for further investigation. While threshold stabilizers had never before been used on thresholds as small as those in Scene-08.2[4](javascript:;), it was believed that the threshold stabilizers could be modified and used to expand one of the micro-thresholds found in Scene-08.2 into a usable route into the wider DevRooms.
...
In October 1994, researchers succeeded in briefly expanding TH-023 from 2 mm to 25 cm. It was successfully held open for three hours. While still unstable and impractical as an exit, a small probe was able to be sent through. The limited exploration that was performed by the probe revealed that TH-023 connected to [Scene-05.12](level-48.md), an A-ranked aquatic scene home to multiple colonies aligned with the Leaders.
...
« [Scene-08.1](level-436.md) | Scene-08.2 | [Scene-08.3](level-51.md) »

## ARCHIVAL NOTICE

An updated version of this page is available.

[View](https://backrooms-wiki.wikidot.com/level-245/offset/1)

Footnotes

[1](javascript:;). Due to an ongoing inability to contact the rest of the Leaders or access a live copy of the General Public Database, this designation remains provisional and may have been given to another scene.

[2](javascript:;). The smallest discovered threshold (TH-172) was estimated to be ~3 micrometers in diameter, and the largest (TH-023) was 2 millimeters in diameter.

[3](javascript:;). Chief researcher of the LRV Zheng He and later Head of Research for Port Sanctuary.

[4](javascript:;). The smallest threshold that had previously successfully been expanded was 50 cm in diameter, 250 times larger than the largest threshold in Scene-08.2

[5](javascript:;). A previously unknown Scene which had evidently been discovered by the Leaders at some point after the LRV Zheng He entered Scene 08.2.

---

Source: [https://backrooms-wiki.wikidot.com/fragment:level-245-0](https://backrooms-wiki.wikidot.com/fragment:level-245-0)
