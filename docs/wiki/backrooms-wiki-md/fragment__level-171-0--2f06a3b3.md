---
title: "Level 171 - \"A Grand Illusion\""
source: "https://backrooms-wiki.wikidot.com/fragment:level-171-0"
retrieved_at: "2026-08-23T23:37:42+00:00"
...
- - \_
  ...
  [Attention: Access to this Level is restricted. Input M.E.G. Security Credentials](javascript:;)[Secure Logout](javascript:;)

  When the lights went out, that is when we lost contact; when **they** were lost in the dark forever.

    
    
    

  ![Missing alt text.](https://live.staticflickr.com/65535/49680513421_6d203b0082_b.jpg)

  Level 171 in a state between the golden age state and the decayed state.

  ![Missing alt text.](https://live.staticflickr.com/1060/534752342_79d09858a4_b.jpg)

  The hallway leading from Level 5 to Level 171.

  ![Missing alt text.](https://backrooms-wiki.wdfiles.com/local--files/level-171/Hotel%20Kitchen%202%20New)
  ...
  **Behavior:** Hostile  
  **Intelligence-Class:** Hive  
  **Description:** The Blight is not comprised of a singular entity, rather it is made up of numerous types of entities classes at IETS 4 danger level. The danger of these entities has also been increased to IETS 5 as a provisionary level. This is in fact due to their almost omnipresent level of intelligence afforded to them by the Signal Lights. They had an innate ability to seek the presence of Wanderers.(See [entity page](http://backrooms-wiki.wikidot.com/theblight) in the database for more vital information.)
  ...
  - **Level 171** may be entered through a wing in [Level 5](level-5.md).
  ...
  [RUN DIAGNOSTICS](javascript:;)

  [RUNNING DIAGNOSTICS](javascript:;)

  [Reload](http://backrooms-wiki.wikidot.com/level-171/offset/1)
...
Discovered By:   
Critique and Other Assistance:   
Theme Designed By:   
Flickering error code: ,   
Diagnostics code: ,   
Feedback:

Picture 1 is "Diamant Palace" by leKorbo.be is licensed with CC BY-SA 2.0. To view a copy of this license, visit <https://creativecommons.org/licenses/by-sa/2.0/>

Picture 2 is "Corridor" by Mike Schmid is licensed with CC BY-SA 2.0. To view a copy of this license, visit <https://creativecommons.org/licenses/by-sa/2.0/>

Picture 3 is "Hotel Kitchen 2" by Timm Suess is licensed with CC BY-SA 2.0. To view a copy of this license, visit <https://creativecommons.org/licenses/by-sa/2.0/>

« [Level 170](level-170.md) | Level 171 | [Level 172](http://backrooms-wiki.wikidot.com/level-172) »

---

Source: [https://backrooms-wiki.wikidot.com/fragment:level-171-0](https://backrooms-wiki.wikidot.com/fragment:level-171-0)
