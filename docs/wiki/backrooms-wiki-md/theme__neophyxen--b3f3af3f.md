---
title: "Neophyxen Theme"
source: "https://backrooms-wiki.wikidot.com/theme:neophyxen"
...
Official theme for the Neophyxen, enigmatic entity native of a hidden space realm.

Theme created by ; scanline effect created by .

To import this theme to your page, put the following text anywhere inside it:

[[include :backrooms-wiki:theme:neophyxen]]

# Examples

![Missing alt text.](http://myrandfox.wikidot.com/local--files/theme:neophyxen/logo)
...
:root {
   ...
   --theme-id: "neophyxen";
   --theme-name: "Neophyxen";
 
   --logo-image: url("http://myrandfox.wikidot.com/local--files/theme:neophyxen/logo");
   --header-title: "Neophyxen Technocracy";
   --header-subtitle: "A new route to be taken.";
   ...
   --bright-accent: 0, 255, 0;
   --medium-accent: 0, 255, 0;
   --dark-accent: 140, 136, 126;
   --pale-accent: 140, 136, 126;
   --custom-text: 0, 160, 0;
 
     /* Primary Theme Colors */
    --swatch-secondary-color: 48,48,52;
...
#extrac-div-2 {
    ...
    top: 0;
    pointer-events: none;
    background: linear-gradient(to bottom, rgba(0,255,0,0) 0%,rgba(0,255,0,1) 50%,rgba(0,255,0,0.98) 51%,rgba(0,255,0,0) 100%);
    opacity : .1;
...
#extrac-div-3 {
    ...
    height: 100vh;
    pointer-events: none;
    background-image: radial-gradient(circle, rgb(0,0,0) 0%, rgb(0,155,0) 60%, rgb(0,255,0) 100%);
    opacity: 0.25;
...
.dark-borderblock {
 ...
 .border-logoblock{
    ...
    background: url(http://myrandfox.wikidot.com/local--files/theme:neophyxen/logo) center/25% no-repeat;
    opacity: 0.25;
    top: 0;
    left: 0;
    bottom: 0;
...
Source: [https://backrooms-wiki.wikidot.com/theme:neophyxen](https://backrooms-wiki.wikidot.com/theme:neophyxen)
