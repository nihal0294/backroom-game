---
title: "Highlighter"
source: "https://backrooms-wiki.wikidot.com/theme:highlighter"
...
rating: +36[+](javascript:; "I like it")[–](javascript:; "I don't like it")[x](javascript:; "Cancel my vote")

  
This theme was created by . The theme isn't bound to any group or canon, so feel free to import it!
...
The theme allows you to customize your page in a rather easy way by add the following code to your page[1](javascript:;):
...
![Missing alt text.](http://backrooms-wiki.wdfiles.com/local--files/component%3Atheme/pridelogo.png)
...
>
> > Nested blockquotes[2](javascript:;)
...
[And links that do exist!](index.md)  
WARNING  
CAUTION  
SAFE
...
[just a link](https://backrooms-wiki.wikidot.com/liurd)
...
[1](javascript:;). **Note:** Add it after the include module!

[2](javascript:;). And here's a footnote!

[3](javascript:;). note

---

Source: [https://backrooms-wiki.wikidot.com/theme:highlighter](https://backrooms-wiki.wikidot.com/theme:highlighter)
