---
title: "Database New"
source: "https://backrooms-wiki.wikidot.com/theme:database-new"
retrieved_at: "2026-08-23T23:41:27+00:00"
...
An adapted version of the database theme by , made to be used as an alternative.  
...
![Missing alt text.](https://myrandfox.wikidot.com/local--files/theme:database-new/logo)
...
:root {
   ...
   --logo-image: url("https://myrandfox.wikidot.com/local--files/theme:database-new/logo");
...
Source: [https://backrooms-wiki.wikidot.com/theme:database-new](https://backrooms-wiki.wikidot.com/theme:database-new)
