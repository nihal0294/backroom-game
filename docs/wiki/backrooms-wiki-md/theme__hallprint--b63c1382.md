---
title: "Hallprint"
source: "https://backrooms-wiki.wikidot.com/theme:hallprint"
...
This theme was created by , based on the [Black Highlighter](https://scp-wiki.wikidot.com/theme:black-highlighter-theme) by , licensed under [CC-BY-SA-3.0](http://creativecommons.org/licenses/by-sa/3.0/). Colour help from the awesomest user on this site aka The Beach aka !
...
This page shows the way the theme looks with no collapsible sidebar. If you want this on your page, use [Show Sidebar](component__show-sidebar--a40acbce.md) to do so.
...
/* Root Variables: When making a new theme, see: https://github.com/Nu-SCPTheme/Black-Highlighter/blob/master/src/css/parts/root.css */
 :root {
    ...
    /* Header */
     --logo-image: url("http://backrooms-wiki.wdfiles.com/local--files/component%3Atheme/newpridelogo.png");
...
Source: [https://backrooms-wiki.wikidot.com/theme:hallprint](https://backrooms-wiki.wikidot.com/theme:hallprint)
