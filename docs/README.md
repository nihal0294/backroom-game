...
8. [`levels/level-0-final-manifest.md`](levels/level-0-final-manifest.md) — Level 0: master map 71-days, trace e settore pilota. La mappa a due piani precedente è **deprecata**.
